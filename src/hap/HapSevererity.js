...
class HapSevererity extends React.Component {
  ...
  render() {
    ...
    const iroad = [' I : 免疫　　悪性腫瘍、または免疫不全状態', 'R: 呼吸　　FiO2>35% 必要', 'O: 意識　　意識レベルの低下', 'A: 年齢　　男性 ≧70歳、女性 ≧75歳', 'D: 脱水　　乏尿または脱水']
    ...
    return (
      <div className={classes.root}>
        <div style={{
              ...
              <Button size = "large" color="primary"  onClick={this.handleClickOpen} label = "40"component = {Link} to = "/haptreat" >
                      治療へ
              </Button>
         </div>
          ...
          <div style={{
            ...
            <Typography  onClick={this.handleClickOpen} style = {{  fontSize: 15, color: "white", textAlign: "center", padding: 10}}>I-ROAD</Typography>
          </div>
          <Card style = {{ maxWidth: 500, margin: "auto", marginTop: 30}}>
            <CardContent>
               { iroad.map( (a, index) => <Qsofa  name = {a} key = {index}/>)}
            </CardContent>
          </Card>
          ...
          <Card style = {{ maxWidth: 500, margin: "auto", marginTop: 30}}>
            ...
            <Dialog
                 ...
                 <DialogContent>
                     ...
                     <DialogContentText style = {{marginTop: 25, color: 'red'}}>I-ROAD ≧1項目　qSOFA ≧２項目<br/>➡︎ 重症 (ICU 検討)</DialogContentText>
